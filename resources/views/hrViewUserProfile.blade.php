...
&nbsp;
								...
								<div class="profile-contact-info">
									<div class="profile-contact-links align-left">
										<a href="{{ url('/hrEditUserProfile/'.$users->id) }}" class="btn btn-link">
											<i class="ace-icon fa fa-pencil bigger-130"></i>
											Edit Profile
										</a>

										<a href="{{ url('/hrUserProfileIdImage/'.$users->id) }}" class="btn btn-link">
											<i class="ace-icon fa fa-user bigger-120 pink"></i>
											Update Profile Image/Id Proof
										</a>

										<a href="{{ url('/hrEditUserAddress/'.$users->id) }}" class="btn btn-link">
