							...
							<div class="row">
								<div class="col-xs-8 col-sm-5">
									<div class="input-group">								
										{!! Form::text('from_date', $ticket->from_date, ['class'=>'form-control date-picker', 'id'=>'id-date-picker-1', 'readonly'=>'readonly','data-date-format'=>'yyyy-mm-dd', 'readonly'=>'readonly', 'placeholder'=>'Leave Start Date']) !!}
